...
window.onload = function () {
    ...
    // 项目图片延迟加载
    if (isPC) {
        $("#swiper-pc .s-pro-item:nth-of-type(1) .s-pro-inner .s-pro-bg").css("background-image","url(img/project.jpg)")
        $("#swiper-pc .s-pro-item:nth-of-type(2) .s-pro-inner .s-pro-bg").css("background-image","url(img/project2.jpg)")
        $("#swiper-pc .s-pro-item:nth-of-type(3) .s-pro-inner .s-pro-bg").css("background-image","url(img/project3.jpg)")
        $("#swiper-pc .s-pro-item:nth-of-type(4) .s-pro-inner .s-pro-bg").css("background-image","url(img/project4.jpg)")
        $("#swiper-pc .s-pro-item:nth-of-type(5) .s-pro-inner .s-pro-bg").css("background-image","url(img/project5.png)")
        $("#swiper-pc .s-pro-item:nth-of-type(6) .s-pro-inner .s-pro-bg").css("background-image","url(img/project6.jpg)")
    } else {
        $("#swiper-mobile .s-pro-item:nth-of-type(1) .s-pro-inner .s-pro-bg").css("background-image","url(img/project.jpg)")
        $("#swiper-mobile .s-pro-item:nth-of-type(2) .s-pro-inner .s-pro-bg").css("background-image","url(img/project2.jpg)")
        $("#swiper-mobile .s-pro-item:nth-of-type(3) .s-pro-inner .s-pro-bg").css("background-image","url(img/project3.jpg)")
        $("#swiper-mobile .s-pro-item:nth-of-type(4) .s-pro-inner .s-pro-bg").css("background-image","url(img/project4.jpg)")
        $("#swiper-mobile .s-pro-item:nth-of-type(5) .s-pro-inner .s-pro-bg").css("background-image","url(img/project5.png)")
        $("#swiper-mobile .s-pro-item:nth-of-type(6) .s-pro-inner .s-pro-bg").css("background-image","url(img/project6.jpg)")
